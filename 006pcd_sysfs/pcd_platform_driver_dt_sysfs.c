...
int pcd_platform_driver_probe(struct platform_device *pdev)
{
	...
	/* 3. Dynamically cllocate memory for the device buffer using size information
	...
	pcdrv_data.device_pcd = device_create(pcdrv_data.class_pcd, dev, dev_data->dev_num,
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("ME");
MODULE_DESCRIPTION("A pseudo character platform driver which handles n platform devices");
